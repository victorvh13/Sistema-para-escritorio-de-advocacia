...
public class Cadastro_Processo extends javax.swing.JFrame {
    ...
    public Cadastro_Processo() {
        ...
        if(DadosTemporarios.tempObject instanceof ModProcesso){
            ...
            int dataprotocolo = ((ModProcesso) DadosTemporarios.tempObject).getDataProtocolo();
            ...
            txtId.setText(String.valueOf(id));
//            txtCadAdvogado.setText(advpgado);
    ...
    private void inserir(){
        ...
        if (daoProcesso.inserir(Integer.parseInt(txtId.getText()), 1, Integer.parseInt(txtNomeAdvogado.getText()), txtCadNProc.getText(), txtCadVara.getText(), txtCadCom.getText(), txtCadData.getText(), txtCadStatus.getText(), txtCadReu.getText())){
